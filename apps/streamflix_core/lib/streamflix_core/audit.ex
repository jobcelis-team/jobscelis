defmodule StreamflixCore.Audit do
  ...
  def action_icon(action) do
    case action do
      ...
      "gdpr.processing_restricted" -> "hero-pause-circle"
      "gdpr.restriction_lifted" -> "hero-play-circle"
      "gdpr.processing_objection" -> "hero-hand-raised"
      "gdpr.processing_consent_restored" -> "hero-check-circle"
