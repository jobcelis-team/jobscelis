defmodule StreamflixWebWeb.Api.V1.PlatformEventSchemasController do
  ...
  plug StreamflixWebWeb.Plugs.RequireScope, "events:write" when action in [:create, :update, :delete, :validate]
  ...
  operation :index,
    ...
    responses: [ok: {"Event schemas", "application/json", StreamflixWebWeb.Schemas.EventSchemaList}]
  ...
  operation :create,
    ...
    request_body: {"Schema params", "application/json", StreamflixWebWeb.Schemas.EventSchemaCreate},
    responses: [created: {"Schema created", "application/json", StreamflixWebWeb.Schemas.EventSchemaResponse}]
  ...
  operation :show,
    ...
    responses: [ok: {"Event schema", "application/json", StreamflixWebWeb.Schemas.EventSchemaResponse}]

  def show(conn, %{"id" => id}) do
    project = conn.assigns.current_project

    case Platform.get_event_schema(id) do
      nil -> conn |> put_status(:not_found) |> json(%{error: "Schema not found"})
      schema ->
  ...
  operation :update,
    ...
    parameters: [id: [in: :path, type: :string, required: true]],
    request_body: {"Schema params", "application/json", StreamflixWebWeb.Schemas.EventSchemaCreate},
    responses: [ok: {"Schema updated", "application/json", StreamflixWebWeb.Schemas.EventSchemaResponse}]
      ...
      schema ->
        if schema.project_id != project.id do
          ...
          case Platform.update_event_schema(schema, attrs) do
            {:ok, updated} -> json(conn, %{data: schema_json(updated)})
            {:error, changeset} ->
              conn |> put_status(:unprocessable_entity) |> json(%{error: "Invalid params", details: format_errors(changeset)})
          end
        end
    end
  end
  ...
  operation :delete,
    ...
    parameters: [id: [in: :path, type: :string, required: true]],
    responses: [ok: {"Schema deleted", "application/json", StreamflixWebWeb.Schemas.EventSchemaResponse}]
      ...
      schema ->
        if schema.project_id != project.id do
          ...
          case Platform.delete_event_schema(schema) do
            ...
            {:error, _} -> conn |> put_status(:unprocessable_entity) |> json(%{error: "Could not delete"})
          end
        end
    end
  end
  ...
  operation :validate,
    ...
    request_body: {"Validation params", "application/json", StreamflixWebWeb.Schemas.EventSchemaValidate},
    responses: [ok: {"Validation result", "application/json", StreamflixWebWeb.Schemas.EventSchemaValidateResponse}]
  ...
  def validate(conn, params) do
    ...
    case Platform.dry_validate_event_payload(project.id, topic, payload) do
      :ok -> json(conn, %{valid: true, errors: []})
