defmodule StreamflixWebWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico robots.txt embed.js)
  ...
  def verified_routes() do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: StreamflixWebWeb.Router,
        statics: StreamflixWebWeb.static_paths()
    end
  end
