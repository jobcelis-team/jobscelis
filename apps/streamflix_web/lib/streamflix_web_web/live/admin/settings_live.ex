defmodule StreamflixWebWeb.Admin.SettingsLive do
  ...
  def render(assigns) do
    ...
    <.admin_layout active="settings" current_user_role={@current_user_role}>
      <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8"><%= gettext("Configuración") %></h1>
      ...
      <div class="bg-white rounded-lg shadow p-4 sm:p-6">
        ...
        <p class="text-gray-600 mt-4">
          ...
          <.link navigate="/platform" class="text-indigo-600 hover:underline">/platform</.link>.
        </p>
      </div>
    </.admin_layout>
    """
